...
export const EMAIL_ENVIRONMENT = {
    ...
    MSURL: {
        EMAIL_SUBSCRIPTION_URL: process.env.MS_EMAIL_SUBSCRIPTION_URL,
        GET_EMAIL_BY_ID: process.env.MS_GET_EMAIL_BY_ID,
        EMAIL_RESOURCE: process.env.MS_EMAIL_RESOURCE
    },
    LOCAL_APP: {
